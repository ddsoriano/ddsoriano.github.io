...
If there is an error, see the R Markdown tab from RStduio to check the right command. It should be at the last part of the message. You can also try installing the *latexpdf* or *pdflatex* package.